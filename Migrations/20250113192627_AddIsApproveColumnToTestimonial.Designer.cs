...
namespace Gym.Migrations
{
    ...
    [Migration("20250113192627_AddIsApproveColumnToTestimonial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym.Models.Card", b =>
                {
            ...
            modelBuilder.Entity("Gym.Models.Profile", b =>
                {
                    ...
                    b.ToTable("PROFILE", "C##OMARSARHAN");
                });

            modelBuilder.Entity("Gym.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("Gym.Models.Subscription", b =>
                {
                    ...
                    b.ToTable("SUBSCRIPTION", "C##OMARSARHAN");
                });
            ...
            modelBuilder.Entity("Gym.Models.Testimonial", b =>
                {
                    ...
                    b.ToTable("TESTIMONIAL", "C##OMARSARHAN");
                });
            ...
            modelBuilder.Entity("Gym.Models.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "Email" }, "SYS_C008445")
                        .IsUnique();

                    b.ToTable("USERS", "C##OMARSARHAN");
                });

            modelBuilder.Entity("Gym.Models.Plan", b =>
                {
                    b.HasOne("Gym.Models.User", "Trainer")
                        .WithMany("Plans")
            ...
            modelBuilder.Entity("Gym.Models.Subscription", b =>
                {
                    b.HasOne("Gym.Models.User", "Member")
                        .WithMany("Subscriptions")
                        .HasForeignKey("Memberid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_SUBSCRIPTION_MEMBER");

                    b.HasOne("Gym.Models.Plan", "Plan")
                        .WithMany("Subscriptions")
